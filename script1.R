...
maps_synthetic_data <- read_csv("maps-synthetic-data.csv")
...
# replace NAs with 0 for anxiety measure age 15 and recode others to numbers
# include < 0.1 recoded as 0
# recode as factors
...
# same as above for depression at 15 measure
maps_synthetic_data[is.na(maps_synthetic_data$dep_band_15), ]$dep_band_15 <- "0"
maps_synthetic_data <- maps_synthetic_data %>%
